...
iData <- readxl::read_excel("./data/dx_readiness_comp_data_20250212.xlsx", sheet = "iData")
iMeta <- readxl::read_excel("./data/dx_readiness_comp_data_20250212.xlsx", sheet = "iMeta")
...
writexl::write_xlsx(dx2, path = "results/dxri_20250212.xlsx")
...
writexl::write_xlsx(dx5, path = "results/dxri_wo_COVID_20250212.xlsx")
